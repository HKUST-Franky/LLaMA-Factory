...
final_format = []
# with open("/root/LLaMA-Factory/data/RoleBench/rolebench-eng/instruction-generalization/general/test.jsonl", "r") as f:
#     for line in f:
#         line = line.strip()
#         if line:
...
with open("/root/LLaMA-Factory/data/RoleBench/rolebench-eng/role-generalization/general/test.jsonl", "r") as f:
    for line in f:
        line = line.strip()
        if line:
            data = json.loads(line)
...
# 写入 JSON 文件
with open("/root/LLaMA-Factory/data/rolellm_general_test.json", "w", encoding="utf-8") as f:
